  ...
  <div class="form-group row">
    ...
    <div class="col-10 input-group">
      ...
      <div class="input-group-append">
        ...
        <button type="button" id="prev" class="btn btn-outline-secondary" onclick="navigate(-1)">Previous</button>
        <button type="button" id="next" class="btn btn-outline-secondary" onclick="navigate(1)">Next</button>
      </div>
    </div>
  </div>
